 ...
 */
 ...
 class PersonWebformHandler extends WebformHandlerBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission) {
    ...
    $field_first_name = $submission_array['full_name'][0]['primary_first_name'];
    $field_middle_name = $submission_array['full_name'][0]['primary_middle_name'];
    $field_last_name = $submission_array['full_name'][0]['primary_last_name'];
